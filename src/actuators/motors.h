 ...
 *
 * Provides functions to control 4 DC motors using H-bridge drivers (L298N, TB6612, etc.)
 ...
 *
 * Configures all 4 motors with PWM channels and direction pins.
 ...
 *
 * Applies active braking to all 4 motors simultaneously.
 */
void stopAllMotors();
